...
namespace Drupal\utevent\Commands;
 ...
 */
class UteventPermissions extends DrushCommands {

  /**
   * Commands for assigning predefined permissions to roles.
   *
   * @command utevent:grant
   * @aliases uteventgrant
   * @options set
   *   Whether or not an extra message should be displayed to the user.
   * @options role
   *   Whether or not an extra message should be displayed to the user.
   *
   * @usage utevent:grant --set=manager --role=utexas_site_manager
   */
