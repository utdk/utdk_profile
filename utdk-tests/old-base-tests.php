...
class BaseInstallationTest extends BrowserTestBase {
  ...
  public function testBaseInstallation() {
    ...
    // --------------------------------------
    // What is this?
    // This section seems to be a placeholder for additional verification steps related to the installation.
    // --------------------------------------
    ...
    // --------------------------------------
    // Verify Flex page meta tags. - new test needed
    // --------------------------------------
    ...
    // --------------------------------------
    // Verify Flex HTML toolbar default values.
    // --------------------------------------
    ...
    // --------------------------------------
    // Verify flex html allowed html and attributes
    // --------------------------------------
    ...
    // --------------------------------------
    // Assert Flex HTML filters not enabled.
    // --------------------------------------
    ...
    // --------------------------------------
    // Assert Flex HTML filters enabled.
    // --------------------------------------
    ...
    // --------------------------------------
    // Set the menu item to a non-link and change the link options. - need new test
    // --------------------------------------
    ...
    // --------------------------------------
    // Make sure that a Content Editor has default access to the Flex HTML format. ???
    // --------------------------------------
    ...
    // --------------------------------------
    // Make sure that a Content Editor doesn't have access to the Full HTML format.
    // --------------------------------------
