...
trait QuickLinksTestTrait {
  ...
  public function verifyQuickLinks() {
    ...
    $assert->responseContains('<a href="https://tylerfahey.com" target="_blank" class="ut-cta-link--external ut-link" rel="noopener noreferrer" aria-label="Quick Links Link!; Link opens in new window">Quick Links Link!</a>');
