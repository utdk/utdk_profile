...
trait TextFormatsTestTrait {
  ...
  public function verifyFlexHtmlSourceEditing() {
    ...
    $allowed_elements = [
      ...
      '<h2 class="test" id="test" role="test">test</h2>',
      '<h3 class="test" id="test" role="test">test</h3>',
      '<h4 class="test" id="test" role="test">test</h4>',
      '<h5 class="test" id="test" role="test">test</h5>',
      '<h6 class="test" id="test" role="test">test</h6>',
