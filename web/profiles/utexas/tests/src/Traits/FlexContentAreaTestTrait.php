...
trait FlexContentAreaTestTrait {
  ...
  public function verifyFlexContentArea() {
    ...
    $edit = [
      ...
      'files[field_flex_page_fca_a_0_subform_field_utexas_fca_items_0_subform_field_utexas_fca_image_0]' => \Drupal::service('file_system')->realpath($this->testImage),
    ...
    $edit = [
      ...
      'files[field_flex_page_fca_b_0_subform_field_utexas_fca_items_0_subform_field_utexas_fca_image_0]' => \Drupal::service('file_system')->realpath($this->testImage),
    ...
    $this->drupalPostForm(NULL, [
      ...
      'field_flex_page_fca_a[0][subform][field_utexas_fca_items][1][subform][field_utexas_fca_cta][0][uri]' => '/node/' . $basic_page->id(),
